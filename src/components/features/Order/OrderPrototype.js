...
const NewOrder = () => {
  ...
  const { olives, redPeppers, greenPeppers, mushrooms, basil, salami } =
    toppings;
  const { cucumber, tomatoes, saladOlives, feta, cheese, herbs, pepper } =
    ingredients;
      ...
      <article className={classes.orderArticle}>
        ...
        <Paper elevation={1} className={classes.orderPaper}>
          <form>
            <Card
              elevation={3}
              className={classes.orderCard + " " + classes.cardMargin}
            >
              <Grid fluid>
                <Row>
                  <Col xs={12} sm={6}>
                  ...
                  <Col xs={9} sm={10}>
                    ...
                    >
                      <Typography
                        variant="h5"
                        className={
                          classes.productTitle + " " + classes.blockMargin
                        }
                      >
            ...
            <Card elevation={3} className={classes.orderCard}>
                ...
                <Row>
                  ...
                  <Col xs={9} sm={8}>
                    ...
                    >
                      ...
                      <Typography component="p" variant="body2">
                        <strong>toppings: </strong>olives, red peppers, green
                        peppers, mushrooms, fresh basil
                      </Typography>
                      <Typography component="p" variant="body2">
